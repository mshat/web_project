...
class Backpack(models.Model):
    ...
    manufacturer = models.ForeignKey('Manufacturer', null=True, on_delete=models.SET_NULL)#, help_text="Select a manufacturer for this backpack")
    type = models.ManyToManyField('Type', blank=True, null=True, help_text="Select a type for this backpack")
    material = models.ManyToManyField('Material', blank=True, null=True, help_text="Select a materials for this backpack")
